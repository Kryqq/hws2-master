...
export const filterAffairs = (affairs: Array<AffairType>, filter: string): Array<AffairType> => {
   switch (filter) {
      case 'high':
         return affairs.filter((a: any) => a.priority === 'high');
      case 'middle':
         return affairs.filter((a: any) => a.priority === 'middle');
      case 'low':
         return affairs.filter((a: any) => a.priority === 'low');
      default:
         return affairs;
   }
};
export const deleteAffair = (affairs: Array<AffairType>, _id: number): any => {
   return affairs.filter((a: any) => a._id !== _id);
};
